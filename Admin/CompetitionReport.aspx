<%@ Page Title="CE Admin" Language="C#" MasterPageFile="~/CEMain.Master" AutoEventWireup="true" CodeBehind="CompetitionReport.aspx.cs" Inherits="CE.Admin.CompetitionReport" %>
    ...
    <div class="ce-admin-content">
        <div id="admin-howto-page">
            ...
            <div class="howto-title">
                <img src="/images/excel-48.png" style="margin-right:10px;" /><span><a class="ce-h5" href="/admin/CompetitionReport.aspx?action=signin&group=individual">Create Individual Talent Competition Sign-In Sheets</a></span>
                <div class="ce-h6">
            ...
            <div class="howto-title">
                <img src="/images/excel-48.png" style="margin-right:10px;" /><span><a class="ce-h5" href="/admin/CompetitionReport.aspx?action=signin&group=team">Create Team Talent Competition Sign-In Sheets</a></span>
                <div class="ce-h6">
            ...
            <div class="howto-title">
                <img src="/images/excel-48.png" style="margin-right:10px;" /><span><a class="ce-h5" href="/admin/CompetitionReport.aspx?action=score&group=individual">Create Individual Talent Competition Score Sheets</a></span>
                <div class="ce-h6">
            ...
            <div class="howto-title">
                <img src="/images/excel-48.png" style="margin-right:10px;" /><span><a class="ce-h5" href="/admin/CompetitionReport.aspx?action=score&group=team">Create Team Talent Competition Score Sheets</a></span>
                <div class="ce-h6">
            ...
            <div class="howto-title">
                <img src="/images/excel-48.png" style="margin-right:10px;" /><span><a class="ce-h5" href="/admin/CompetitionReport.aspx?action=contestant&group=both">Create Participating Competitions Per Contestant Report</a></span>
                <div class="ce-h6">
            ...
            <div class="howto-title">
                <img src="/images/excel-48.png" style="margin-right:10px;" /><span><a class="ce-h5" href="/admin/CompetitionReport.aspx?action=headcount&group=both">Create Talent Competition Head Count Report</a></span>
                <div class="ce-h6">
            ...
            <div class="howto-title">
                <img src="/images/excel-48.png" style="margin-right:10px;" /><span><a class="ce-h5" href="/admin/CompetitionReport.aspx?action=conflict&group=individual">Create Conflicting Competitions Report</a></span>
                <div class="ce-h6">
            ...
            <div class="howto-title">
                <img src="/images/excel-48.png" style="margin-right:10px;" /><span><a class="ce-h5" href="/admin/CompetitionReport.aspx?action=trophy&group=both">Create Throphy Count Report</a></span>
                <div class="ce-h6">
            ...
            <div class="howto-title">
                <img src="/images/excel-48.png" style="margin-right:10px;" /><span><a class="ce-h5" href="/admin/CompetitionReport.aspx?action=awards&group=both">Create Competition Award Presentation Report</a></span>
                <div class="ce-h6">
            ...
            <div class="howto-title">
                <img src="/images/excel-48.png" style="margin-right:10px;" /><span><a class="ce-h5" href="/admin/CompetitionReport.aspx?action=winners&group=both">Create Competition Winners List</a></span>
                <div class="ce-h6">
            ...
            <div class="howto-title">
                <img src="/images/excel-48.png" style="margin-right:10px;" /><span><a class="ce-h5" href="/admin/CompetitionReport.aspx?action=certificate&group=both">Create Competition Winner Certificates</a></span>
                <div class="ce-h6">

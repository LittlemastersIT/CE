    ...
    <div id="ce-admin-content">
        <div id="admin-howto-page">
            ...
            <div class="howto-title">
                <img runat="server" src="~/images/pdf.png" /><span><a runat="server" class="ce-h5" href="~/admin/references/CE Web Site Content Update Tool.pdf" target="_blank">Content Upload/Download Tool</a></span>
                <div class="ce-h6">
            ...
            <div class="howto-title">
                <img runat="server" src="~/images/pdf.png" /><span><a runat="server" class="ce-h5" href="~/admin/references/CE Web Hosting Server Connection.pdf" target="_blank">Connect to CE Hosting Server</a></span>
                <div class="ce-h6">
            ...
            <div class="howto-title">
                <img runat="server" src="~/images/pdf.png" /><a runat="server" class="ce-h5" href="~/admin/references/CE Web Site Content File Structure.pdf" target="_blank">Content Folder Structure</a>
                <div class="ce-h6">
            ...
            <div class="howto-title">
                <img runat="server" src="~/images/pdf.png" /><a runat="server" class="ce-h5" href="~/admin/references/CE Web Site Content Creation Guide.pdf" target="_blank">Content Creation/Modification Guide</a>
                <div class="ce-h6">
            ...
            <div class="howto-title">
                <img runat="server" src="~/images/pdf.png" /><a runat="server" class="ce-h5" href="~/admin/references/CE Web Site Article Content Authoring.pdf" target="_blank">Authoring CE Article</a>
                <div class="ce-h6">
            ...
            <div class="howto-title">
                <img runat="server" src="~/images/pdf.png" /><a runat="server" class="ce-h5" href="~/admin/references/CE Web Site Album Content Authoring.pdf" target="_blank">Authoring CE Album</a>
                <div class="ce-h6">
            ...
            <div class="howto-title">
                <img runat="server" src="~/images/pdf.png" /><a runat="server" class="ce-h5" href="~/admin/references/CE Web Site Journey Content Authoring.pdf" target="_blank">Authoring CE Journey</a>
                <div class="ce-h6">
            ...
            <div class="howto-title">
                <img runat="server" src="~/images/pdf.png" /><a runat="server" class="ce-h5" href="~/admin/references/CE Web Page Creation for Content.pdf" target="_blank">Generating CE Web Page for Content</a>
                <div class="ce-h6">
            ...
            <div class="howto-title">
                <img runat="server" src="~/images/pdf.png" /><a runat="server" class="ce-h5" href="~/admin/references/CE Tour Application Online Process.pdf" target="_blank">CE Tour Application Online Process</a>
                <div class="ce-h6">
            ...
            <div class="howto-title">
                <img runat="server" src="~/images/pdf.png" /><a runat="server" class="ce-h5" href="~/admin/references/CE talent Competition Online Process.pdf" target="_blank">CE Talent Competition Online Process</a>
                <div class="ce-h6">
            ...
            <div class="howto-title">
                <img runat="server" src="~/images/pdf.png" /><a runat="server" class="ce-h5" href="~/admin/references/How to Update Tour Journey for New Program Year.pdf" target="_blank">Update Program Year for CE Tour</a>
                <div class="ce-h6">
            ...
            <div class="howto-title">
                <img runat="server" src="~/images/pdf.png" /><a runat="server" class="ce-h5" href="~/admin/references/Yearly CE Web Application Update Guidelines.pdf" target="_blank">Yearly CE Web Application Update Guidelines</a>
                <div class="ce-h6">

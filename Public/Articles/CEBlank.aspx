<%@ Page Language="C#" MasterPageFile="~/CEMain.Master" AutoEventWireup="true" CodeBehind="CEBlank.aspx.cs" Inherits="CE.Pages.BlankPage" %>
            ...
            <table style="width:100%">
                <tr>
                    ...
                    <td class="ce-text-cell">
                        <div class="ce-text">
                            Thank you for visiting. This Cultural Exploration page is currently under construction.
                        </div>
                    </td>
                </tr>
            </table>
